...
class TenderInfoBlocks extends StatefulWidget {
  const TenderInfoBlocks({super.key});

  @override
  State<TenderInfoBlocks> createState() => _TenderInfoBlocksState();
}

class _TenderInfoBlocksState extends State<TenderInfoBlocks> {
  ...
  Future<void> _loadJson() async {
    ...
    {
  "overview": {
    "tags": ["Construction", "Government", "Roads"],
